...
if st.button("Mulai Analisis"):
    ...
    # gabung dengan data lama kalau ada
    ...
    with open(file, "rb") as f:
        st.download_button(
            "Download Excel",
            f,
            file_name="hasil_mindscroll.xlsx"
        )
    ...
    data_akhir.to_excel("hasil_mindscroll.xlsx", index=False)
...
if st.button("🗑 Reset Data Excel"):
    ...
    if os.path.exists(file):
        os.remove(file)
        st.success("Data Excel berhasil dihapus")
    else:
